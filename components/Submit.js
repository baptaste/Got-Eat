...
import { colorSchemeState, isLoadingState, hasSubmitRecipeState } from '../store/atoms/settings'
import { recipeQueryState } from '../store/selectors/getRequests'
...
export default function Submit() {
  ...
  const [hasSubmit, setHasSubmit] = useRecoilState(hasSubmitRecipeState)
